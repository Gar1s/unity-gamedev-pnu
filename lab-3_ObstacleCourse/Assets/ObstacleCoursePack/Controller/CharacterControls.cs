...
public class CharacterControls : MonoBehaviour
{
	...
	public float standingTimeThreshold = 5f;
	...
	private void Update()
	{
		...
		// check if standing for 5 sec
		if (IsCharacterStanding())
		{
			standingTimer += Time.deltaTime;

			if (standingTimer >= standingTimeThreshold)
			{
		...
		{
			++stepCounter;
			countStep.text = "Steps = " + stepCounter;
		}


	}

	bool IsCharacterStanding()
	{
		if (rb != null)
		{
